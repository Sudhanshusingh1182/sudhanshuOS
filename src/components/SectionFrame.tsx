      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          <div className="min-w-0">
            <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-neon sm:text-xs">{eyebrow}</p>
            <h2 className="mt-2 font-mono text-2xl font-black uppercase sm:text-3xl lg:text-4xl">{title}</h2>
          </div>
