  ...
  return (
    <main className="scanlines min-h-screen overflow-x-hidden bg-void text-white">
      ...
      <section id="home" className="relative flex min-h-screen items-center px-4 py-24 sm:px-6 lg:px-10">
        ...
        <div className="relative mx-auto grid w-full max-w-7xl gap-10 lg:grid-cols-[1.08fr_.92fr] lg:items-center">
          <div>
            ...
            <div className="mt-1 h-0.5 w-24 bg-neon/60" />
            ...
            <div className="mt-8 hud-panel max-w-2xl p-5">
              ...
              <p className="mt-3 text-xl font-semibold leading-relaxed">&quot;{portfolioConfig.profile.mission}&quot;</p>
            </div>
